...
@Entity
public class CalendarioReceber implements Comparable<CalendarioReceber> {
	...
	@Transient
	private List<CalendarioReceber> listaCalendario;
	...
	public List<CalendarioReceber> getListaCalendario() {
		return listaCalendario;
	}

	public void setListaCalendario(List<CalendarioReceber> listaCalendario) {
	...
	@Override
	public int compareTo(CalendarioReceber o) {
